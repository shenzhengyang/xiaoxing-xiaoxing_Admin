...
class GeocodingController extends Controller
{
    ...
    //ak
    const AK='qnLHzcGG1Ox9kmSG1Njm7onO0ydV6Ys6';
    /**
     * 根据地址获取国家、省份、城市及周边数据
     ...
     * @return Array
     */
    public  function getAddressComponent($longitude, $latitude, $ak=self::AK, $pois=self::NO_POIS){
        ...
        // 请求百度api
        $response = $this->toCurl(self::API, $param);
