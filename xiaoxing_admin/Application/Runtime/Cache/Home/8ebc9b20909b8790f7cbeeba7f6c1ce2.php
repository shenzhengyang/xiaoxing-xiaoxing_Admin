...
<script src="../../Public/Js/TableJs/TableManager/table_feedback.js"></script>
...
<div class="container" id="container">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">新增反馈数据</h4>
                </div>
                <div class="modal-body">
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-eid">用户id</span>
                        <input type="text" class="form-control" placeholder="用户id" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-lat">时间</span>
                        <input type="text" class="form-control" placeholder="时间：2017-10-12 10:10:00" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-lng">反馈详细信息</span>
                        <input type="text" class="form-control" placeholder="反馈详细信息" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-radius">是否已改正</span>
                        <select class="form-control" placeholder="是否已改正 0：未更改，1：已更正">
                            <option>0</option>
                            <option>1</option>
                        </select>
                    </div>
    ...
    <div class="row">
        <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
            ...
            <table class="table table-hover" id="table" data-toggle="table" data-url="feedback_json"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="uid" data-editable="input">用户id</th>
                        <th data-field="time" data-editable="input">时间</th>
                        <th data-field="desc" data-editable="input">反馈详细信息</th>
                        <th data-field="hasrepaired" data-editable="input">是否更正错误</th>
                    </tr>
                </thead>
            </table>
        </div>
