...
<script src="../../Public/Js/TableJs/TableManager/table_equip.js"></script>
...
<div class="container" id="container">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">新增设备绑定手机数据</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-phone">绑定的手机号</span>
                        <input type="text" class="form-control" placeholder="绑定的手机号" aria-describedby="basic-addon1">
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
            ...
            <table class="table table-hover" id="table" data-toggle="table" data-url="equip_json"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="imei" data-editable="input">设备编号</th>
                        <th data-field="phone" data-editable="input">设备绑定的手机号</th>
                    </tr>
                </thead>
            </table>
        </div>
