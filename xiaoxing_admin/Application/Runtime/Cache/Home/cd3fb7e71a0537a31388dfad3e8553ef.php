...
<script src="../../Public/Js/TableJs/TableManager/table_position.js"></script>
...
<div class="container" id="container">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">新增定位数据</h4>
                </div>
                <div class="modal-body">
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-eid">eid</span>
                        <input type="text" class="form-control" placeholder="设备编号" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-lat">lat</span>
                        <input type="text" class="form-control" placeholder="经度" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-lng">lng</span>
                        <input type="text" class="form-control" placeholder="纬度" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-speed">speed</span>
                        <input type="text" class="form-control" placeholder="设备速度" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-inrail">inrail</span>
                        <select class="form-control" placeholder="是否在围栏中0~1">
                            <option>0</option>
                            <option>1</option>
                        </select>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-battery">battery</span>
                        <!--<input type="text" class="form-control" placeholder="电量0~100" aria-describedby="basic-addon1">-->
                        <select class="form-control" placeholder="电量0~100">
                            <?php for($i=0;$i<=100;$i++){ echo "<option>".$i."</option>"; } ?>
                        </select>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-time">time</span>
                        <input type="text" class="form-control" placeholder="时间:2016-09-24 11:55:17" aria-describedby="basic-addon1">
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
            ...
            <table class="table table-hover" id="table" data-toggle="table" data-url="position_json"
                   ...
                   data-click-to-select="true" data-click-edit="true" data-unique-id="id" data-toolbar="#toolbar"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="eid" data-editable="input">eid</th>
                        <th data-field="lat" data-editable="input">lat</th>
                        <th data-field="lng" data-editable="input">lng</th>
                        <th data-field="speed" data-editable="input">speed</th>
                        <th data-field="inrail" data-editable="input">inrail</th>
                        <th data-field="battery" data-editable="input">battery</th>
                        <th data-field="time" data-editable="input">time</th>
                    </tr>
                </thead>
            </table>
        </div>
